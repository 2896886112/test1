    ...
    <div id="bd">
        <div class="wrap clearfix">
            <div class="sidebar">
                ...
                <ul class="nav">
                    <li class="office current"><div class="nav-header"><a href="javascript:;" data-src="apply.html" class="clearfix"><span>行程单打印申请</span><i class="icon"></i></a></div></li>
                    <li class="gongwen"><div class="nav-header"><a href="javascript:;" data-src="send_msg.html" class="clearfix"><span>打印申请状态</span><i class="icon"></i></a></div></li>
                </ul>
            </div>
            <div class="content">
                ...
                <iframe src="apply.html" id="iframe" width="100%" height="100%" frameborder="0"></iframe>
            </div>
        </div>
    </div>
</div>
